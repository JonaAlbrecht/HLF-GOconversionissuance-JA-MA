...
# enroll the ca for buyer org cryptomaterial creation, the flag --tls.certfiles paths to the issuing body certificate authority root certificate
  ...
  echo
  fabric-ca-client register --caname ca.issuer.GOnetwork.com --id.name b-peer0 --id.secret b-peer0pw --id.type peer --tls.certfiles ${PWD}/../../issuer-vm3/create-cryptomaterial-issuer/fabric-ca/issuer/tls-cert.pem

  echo
  echo "Register b-peer1"
  echo
  fabric-ca-client register --caname ca.issuer.GOnetwork.com --id.name b-peer1 --id.secret b-peer1pw --id.type peer --tls.certfiles ${PWD}/../../issuer-vm3/create-cryptomaterial-issuer/fabric-ca/issuer/tls-cert.pem

  echo
  echo "Register b-user"
  echo
  fabric-ca-client register --caname ca.issuer.GOnetwork.com --id.name b-user1 --id.secret b-user1pw --id.type client --tls.certfiles ${PWD}/../../issuer-vm3/create-cryptomaterial-issuer/fabric-ca/issuer/tls-cert.pem

  echo
  echo "Register the org admin"
  echo
  fabric-ca-client register --caname ca.issuer.GOnetwork.com --id.name buyeradmin --id.secret buyeradminpw --id.type admin --tls.certfiles ${PWD}/../../issuer-vm3/create-cryptomaterial-issuer/fabric-ca/issuer/tls-cert.pem
  ...
  echo
  fabric-ca-client enroll -u https://b-peer0:b-peer0pw@localhost:10054 --caname ca.issuer.GOnetwork.com -M ${PWD}/../crypto-config/peerOrganizations/buyer.GOnetwork.com/b-peers/b-peer0.buyer.GOnetwork.com/msp --csr.hosts b-peer0.buyer.GOnetwork.com --tls.certfiles ${PWD}/../../issuer-vm3/create-cryptomaterial-issuer/fabric-ca/issuer/tls-cert.pem
  ...
  echo
  fabric-ca-client enroll -u https://b-peer0:b-peer0pw@localhost:10054 --caname ca.issuer.GOnetwork.com -M ${PWD}/../crypto-config/peerOrganizations/buyer.GOnetwork.com/b-peers/b-peer0.buyer.GOnetwork.com/tls --enrollment.profile tls --csr.hosts b-peer0.buyer.GOnetwork.com --csr.hosts localhost --tls.certfiles ${PWD}/../../issuer-vm3/create-cryptomaterial-issuer/fabric-ca/issuer/tls-cert.pem
  ...
  echo
  fabric-ca-client enroll -u https://b-peer1:b-peer1pw@localhost:10054 --caname ca.issuer.GOnetwork.com -M ${PWD}/../crypto-config/peerOrganizations/buyer.GOnetwork.com/b-peers/b-peer1.buyer.GOnetwork.com/msp --csr.hosts b-peer1.buyer.GOnetwork.com --tls.certfiles ${PWD}/../../issuer-vm3/create-cryptomaterial-issuer/fabric-ca/issuer/tls-cert.pem
  ...
  echo
  fabric-ca-client enroll -u https://b-peer1:b-peer1pw@localhost:10054 --caname ca.issuer.GOnetwork.com -M ${PWD}/../crypto-config/peerOrganizations/buyer.GOnetwork.com/b-peers/b-peer1.buyer.GOnetwork.com/tls --enrollment.profile tls --csr.hosts b-peer1.buyer.GOnetwork.com --csr.hosts localhost --tls.certfiles ${PWD}/../../issuer-vm3/create-cryptomaterial-issuer/fabric-ca/issuer/tls-cert.pem
  ...
  echo
  fabric-ca-client enroll -u https://b-user1:b-user1pw@localhost:10054 --caname ca.issuer.GOnetwork.com -M ${PWD}/../crypto-config/peerOrganizations/buyer.GOnetwork.com/b-users/b-User1@buyer.GOnetwork.com/msp --tls.certfiles ${PWD}/../../issuer-vm3/create-cryptomaterial-issuer/fabric-ca/issuer/tls-cert.pem
  ...
  echo
  fabric-ca-client enroll -u https://buyeradmin:buyeradminpw@localhost:10054 --caname ca.issuer.GOnetwork.com -M ${PWD}/../crypto-config/peerOrganizations/buyer.GOnetwork.com/b-users/Admin@buyer.GOnetwork.com/msp --tls.certfiles ${PWD}/../../issuer-vm3/create-cryptomaterial-issuer/fabric-ca/issuer/tls-cert.pem
