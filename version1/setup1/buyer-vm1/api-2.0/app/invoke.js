...
const invokeTransaction = async (channelName, chaincodeName, fcn, args, username, org_name, transientData) => {
    try {
        ...
        let result
        let message;
        if (fcn === "createGO" || fcn === "createPrivateGOImplicitForbuyer"
            || fcn == "createPrivateGOImplicitForeproducer") {
        ...
        } else if (fcn == "createPrivateGO" || fcn == "updatePrivateData") {
            ...
            return `Invocation require either createCar or changeGOOwner as function but got ${fcn}`
        }
