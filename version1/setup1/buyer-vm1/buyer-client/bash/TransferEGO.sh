...
export PEER0_BUYER_CA=/etc/hyperledger/channel/crypto-config/peerOrganizations/issuer.GOnetwork.com/i-peers/i-peer0.issuer.GOnetwork.com/tls/ca.crt
...
TransfereGO() {
    ...
    setGlobalsForPeer0buyer
    export TransferInput=$(echo -n "{\"EGO\":\"eGO1\",\"Recipient\":\"hproducerMSP\"}" | base64 | tr -d \\n)
