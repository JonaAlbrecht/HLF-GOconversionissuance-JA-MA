...
var functionMap map[string]func(ctx contractapi.TransactionContextInterface) error
...
func (s *SmartContract) createElectricityGO(ctx contractapi.TransactionContextInterface) error {
	...
	currentCounteGO := counter.EGOcounter()
...
func (s *SmartContract) issuehGO(ctx contractapi.TransactionContextInterface) error {
	...
	currentCounthGO := counter.HGOcounter()
	...
	currentCounteGO1 := counter.EGOcounter()
...
func (s *SmartContract) claimRenewableattributesElectricity(ctx contractapi.TransactionContextInterface) error {
	...
	currentCancelKeyCount := counter.ECancelcounter()
...
func (s *SmartContract) claimRenewableattributesHydrogen(ctx contractapi.TransactionContextInterface) error {
	...
	currentCancelKeyCount := counter.HCancelcounter()
...
//func initFunctionMap(s *SmartContract) {
	//functionMap = map[string]func(contractapi.TransactionContextInterface) error{
		//"createElectricityGO": func(ctx contractapi.TransactionContextInterface) error{
			//return s.createElectricityGO(ctx)
		//},
		//"addHydrogentoBacklog": func(ctx contractapi.TransactionContextInterface) error{
			//return s.addHydrogentoBacklog(ctx)
		//},
		//"issuehGO": func(ctx contractapi.TransactionContextInterface) error{
			//return s.issuehGO(ctx)
		//},
		//"transfereGOtohproducer": func(ctx contractapi.TransactionContextInterface, neededAmount float64) error{
			//return s.transfereGOtohproducer(ctx, neededAmount)
		//},
